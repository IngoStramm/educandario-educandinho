...
class EDU_Post_Type
{
    ...
    protected function labels()
    {
        $default = array(
            ...
            'add_new'            => __('Add New', 'edu'),
            'add_new_item'       => sprintf(__('Add New %s', 'edu'), $this->name),
            'new_item'           => sprintf(__('New %s', 'edu'), $this->name),
            'all_items'          => sprintf(__('All %ss', 'edu'), $this->name),
            'not_found'          => sprintf(__('No %s found', 'edu'), $this->name),
            'not_found_in_trash' => sprintf(__('No %s found in Trash', 'edu'), $this->name)
        );
