...
- Educandário (Nome do plugin)
- educandario (nome dos arquivos, nome do text domain e slug da url do repositório)
- EDU_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- edu_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Educandário, através do próprio sistema de atualizações do WordPress
